...
def ScraperMainTask(urls, id):
    ...
    removecomma = r","
    removeapostrophe = r"'"
    #matchGB = r"[\d\s]*(\$/TB|\$/GB|\$/MB|TB\/s|GB\/s|MB\/s|MB|GB|TB|GHz|MHz|W|bit|mm|Years|%|RPM)"
    #removeGB = r"(\$/TB|\$/GB|\$/MB|TB\/s|GB\/s|MB\/s|MB|GB|TB|GHz|MHz|W|bit|mm|Years|%|RPM)"
...
def ScraperUpload(item, ComponentUpload, DetailsUpload):
