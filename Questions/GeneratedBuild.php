                        ...
                        <div class="result-head">
                            <p>
                                ...
                                <a href="<?php echo $BuildItem["CompLink"]?>" target="_blank">
                                    ...
                                    echo  "<br /> $" . $BuildItem['CompPrice'] . "<br />";
                                    $price = $price + $BuildItem['CompPrice'];
                                    ?>
                                </a>
                                <?php if ($key == "Case"){ ?>
                                    <a href="https://pricespy.co.nz/category.php?m=s322380888" target="_blank"><u>We get it, cases are personal.<br /> Pick your own here</u></a>
                                <?php };?>
                                <?php if ($key == "MotherBoard" && !isset($CurrentBuild["WirelessAdapter"]) && $_SESSION['UserAnswers']['WiFi'] == "Yes") {?>
                                    with Onboard wireless
                                <?php };?>
                            </p>
